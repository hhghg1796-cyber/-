                    ...
                    onAddMoreFiles = {
                        val newFiles = listOf(
                            FileImportItem(
                                ...
                                fileName = "وثيقة_مستوردة_إضافية_${importFiles.size + 1}.pdf",
                                fileExtension = "PDF",
                                sizeFormatted = "4.2 ميجابايت",
                                pageCountEstimate = 8
                            )
                        )
