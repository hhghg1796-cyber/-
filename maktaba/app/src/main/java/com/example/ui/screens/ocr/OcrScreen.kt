...
fun OcrScreen(
    ...
    var internalOcrStatus by remember {
        mutableStateOf(document.pages.getOrNull(pageNumber - 1)?.ocrStatus ?: document.ocrStatus)
    }

    var localSearchQuery by remember { mutableStateOf("") }
    val page = document.pages.getOrNull(pageNumber - 1)
    val pageText = page?.ocrText ?: ""
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(
                        onClick = {
                            clipboardManager.setText(AnnotatedString(pageText))
                            scope.launch {
                    ...
                    OutlinedButton(
                        onClick = {
                            ...
                            scope.launch {
                                ...
                                snackbarHostState.showSnackbar("تمت إعادة استخراج النص بنجاح")
                            }
                        },
